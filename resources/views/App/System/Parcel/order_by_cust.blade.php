...
@section('title', 'DANIKA | Order by Customer')
@section('contents')
    <div class="container py-2">
        <div class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <form action="{{ route('app.parcel.OrderByCustCheck') }}" method="POST" enctype="multipart/form-data"
                    id="frm_checkBarcode">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (result.result == true) {
                            ...
                            window.location.href = '/app/parcel/cust/order/';
                            _complete()
                        } else {
                            _error()
                        }

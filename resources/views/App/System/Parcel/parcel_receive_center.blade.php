...
@section('title', 'DANIKA | Reciever Parcel')
@section('contents')
    <div class="container py-2">
        <div class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <form action="{{ route('app.parcel.recievestore') }}" method="POST" enctype="multipart/form-data"
                    id="form-barcode">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name="parcel_barcode" id="parcel_barcode">
                ...
                <center>
                    <button class="btn btn-primary" type="button" onclick="$('#adddetail').modal('show')"
    ...
    <!-- Modal -->
    @include('App.System.Parcel.parcel_receive_center_modal_customer')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form-barcode').on('submit', function(event) {
            ...
            $.ajax({
                url: "{{ route('app.parcelstepfirst.show.multipleStep3') }}",
                method: "GET",
                contentType: false,
                dataType: 'json',
                processData: false,

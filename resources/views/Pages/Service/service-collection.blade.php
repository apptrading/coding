...
@section('title', 'DANIKA | collection')
@section('contents')
    <main id="main">
                ...
                <div class="container position-relative">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-6 text-center">
                            <h2 class="laos fw-bold">ບໍລິການຮັບພັດສະດຸດ້ວຍຕົວເອງ</h2>
                    ...
                    <div class="col-lg-4">
                        <div class="services-list">
                            <a href="{{ route('service.cod', ['lang' => session('langs')]) }}"
                                class="laos">ບໍລິການເກັບເງິນປາຍທາງ</a>
                            <a href="{{ route('service.collection', ['lang' => session('langs')]) }}"
                                class="active laos">ບໍລິການຮັບພັດສະດຸດ້ວຍຕົວເອງ</a>
